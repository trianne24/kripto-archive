...
//Sumber: www.programmersheaven.com
...
//Expansion Function applied on `right' half
void Des::Expansion(){
    int exp[8][6],i,j,k;
    for( i=0; i<8; i++){
        for( j=0; j<6; j++){
...
void header(){
    system("CLS");
    cout<<"- - - - - - - - - - - - - - - - - - - - - - - - - - - "<<endl;
    cout<<"|              PROGRAM KRIPTO DES CIPHER             |"<<endl;
    cout<<"- - - - - - - - - - - - - - - - - - - - - - - - - - - "<<endl;
}
...
void quit(){
    ...
    cout<<"- - - - - - - - - - - - - - - - - - - - - - - - - - - "<<endl;
    cout<<"By :\nAngga Kresnabayu\t140810160001\nM. Naufal Monoarfa\t140810160033\nAdryan Luthfi Faiz\t140810160049\nM. Rifqy Aulia A.\t140810160055\nPatricia Joanne\t140810160065"<<endl;
}
...
void menuEnkrip(){
    ...
    cout<<"\n ENKRIPSI - - - "<<endl;
    cout<<"Pilihlah cara inputan: "<<endl;
    cout<<"1. Diketik"<<endl;
    cout<<"2. Masukan lewat Input.txt"<<endl;
    ...
    do {
        if(inputEnkrip==1)
            cekEnkrip = true;
        else if(inputEnkrip== 2)
            cekEnkrip = true;
        else
            cekEnkrip = false;
		
        if(cekEnkrip == false){
            cout<<"\nInputan anda salah, silahkan masukan kembali:";
            cin>>inputEnkrip;
        }
    }
	while(!cekEnkrip);
    ...
    switch(inputEnkrip){
		...
		case 2 : {
			cout<<"\nCara pemakaian: ";
			cout<<"1. Buka input.txt\n2. Tuliskan text yang ingin dienkrip di Input.txt\n3. Save\n4. jika sudah di-save, PRESS ANY KEY "<<endl;
			getch();
			...
			char *str2 = new char[inputan.length()+1];
			strcpy(str2,inputan.c_str());
			str1=d1.Encrypt(str2);
			ofstream ofs("Output.txt");
			ofs<<str1;
			ofs.close();
			ofstream ofs2("Cipher.txt");
			ofs2<<str1;
			ofs2.close();
			cout<<"Cipher text disimpan dalam Output.txt"<<endl;
			getch();
			menuUtama();
		}
        break;
...
void menuDekrip(){
    ...
    bool cekDekrip;
    cout<<"\n DEKRIPSI - - - "<<endl;
    cout<<"\nPilihlah cara inputan: "<<endl;
    cout<<"1. Diketik"<<endl;
    cout<<"2. Membaca Cipher.txt"<<endl;
    cout<<"Masukan angkanya: ";
    cin>>inputDekrip;
    do {
        if(inputDekrip==1)
            cekDekrip = true;
        else if(inputDekrip== 2)
            cekDekrip = true;
        else
            cekDekrip = false;
    ...
    switch(inputDekrip){
		...
		case 2 : {
			cout<<"\nCara pemakaian: ";
			cout<<"1. Buka Cipher.txt\n2. Tuliskan text yang ingin didekrip di Cipher.txt\n3. Save\n4. jika sudah di-save, PRESS ANY KEY "<<endl;
			getch();
			...
			char *str2 = new char[inputan.length()+1];
			strcpy(str2,inputan.c_str());
			str1=d1.Decrypt(str2);
			ofstream ofs("Plain.txt");
			ofs<<str1;
			ofs.close();
			cout<<"Cipher Text\t:\n"<<str2;
			cout<<"\nPlain Text\t:\n"<<str1;
			cout<<"\n\nPlain text disimpan dalam Plain.txt"<<endl;
			getch();
			menuUtama();
		}
        break;
